...
public class ArrayReview {
    public static void main(String[] args) {
        ...
        int numberOfEkements= array.length;
        System.out.println(numberOfEkements);

        System.out.println(array[3]);  //getting1 element from an array
        ...
        we use enhanced for loop ONLY arrays or collection
             */
